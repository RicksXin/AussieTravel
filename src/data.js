...
export const days = [
  ...
  },
  {
    ...
    "events": [
      ...
      },
      {
        ...
        "note": "住宿：盛橡 Oaks Melbourne on William Suites（350 William St）。回房休息，次日早餐在维妈市场解决。\n超市补给按体力决定，Coles资料见原备注。\n次日补给（按9/27行程推算）：白天维妈市场→州立图书馆→皇家拱廊→福林德车站→NGV基本全程步行，12:00 Max午餐到18:45 Palermo晚餐之间隔近7小时，备每人1–2瓶水和耐放小食。早餐在维妈市场吃，不用买。原表记Coles营业6:00–23:00。",
        "row": 75,
        "id": "2026-09-26-10"
      }
    ],
  ...
  },
  {
    ...
    "events": [
      ...
      },
      {
        ...
        "note": "原表路线：市政厅 →（步行 400 米、约 6 分钟，途经圣保罗大教堂）→ 涂鸦街 Hosier Ln「经过即可」→ 可途经联邦广场（顶多歇脚）→ 福林德车站。\n拍车站的两个机位在下一项圣保罗大教堂里：斜对角的长椅与教堂台阶。",
        "row": 129,
        "id": "2026-09-27-3"
      },
      {
        ...
        "title": "圣保罗大教堂",
        "type": "spot",
        "place": "St Paul's Cathedral Melbourne",
        "note": "就在福林德车站斜对角，原表与车站记在同一行。免费进入；礼拜时间保持安静，严禁开闪光灯。\n原表两个机位都是从教堂这侧拍车站：【1】教堂对角的长椅（原表记为「周董同款」，最热门）；【2】教堂对面台阶，能把车站和红绿灯一起纳入全景。\n开放时间与礼拜安排未核实，以现场公告为准。",
        "row": 137,
        "id": "2026-09-27-cathedral"
      },
      {
        "time": null,
        "title": "维多利亚国家美术馆",
      ...
      {
        "time": null,
        "title": "超市补给 · 为大洋路备早餐与水",
        "type": "shop",
        "place": "Coles Melbourne CBD",
        "note": "次日补给（按9/28大洋路一日游推算）：这一晚是全程最不能省的一次补给。原表9/28写明「早餐：出发前在房间吃前夜准备的面包、酸奶或三明治」，且出发时间由团方9/27通知、可能很早，酒店早餐赶不上，必须今晚买好。\n清单：面包／三明治＋酸奶（次日车上或房内早餐）、每人 2 瓶水（原表提醒带水，全天跟车、停留点少）、耐放小食。原表另提醒带防风衣，并记有信用卡与每人 5 澳元现金。\nColes 营业 6:00–23:00（原表），Palermo 晚餐后仍可顺路。",
        "row": 155,
        "id": "2026-09-27-supply"
      }
    ],
    "number": 2
  },
    ...
    "events": [
      {
        ...
        "note": "集合地址：206 A'Beckett St（用户确认）。盛橡350 William St出发，步行前往集合点；按导航及团方要求提前到达。确切集合时间9/27由团方通知，收到后再安排起床、早餐和出门时间。\n返程也在这里下车（团方确认「在上车地点下车」），从这里步行回盛橡。\n9/28出发时间以9/27团方通知为准；原07:50不作为确定时间。团方已确认 5 个景点及顺序：十二门徒 → 吉布森石阶 → 洛克阿德大峡谷 → 大洋路野生动物园（自费可选）→ 阿波罗湾。各站时刻均未给出，原表参考时刻只写在各站备注里。",
        "row": 167,
        "id": "2026-09-28-0"
      },
      {
        "time": null,
        "title": "途中服务区休息 · 非团方行程项",
        "type": "transit",
        "place": "Colac Victoria",
        "note": "团方确认的行程只列了 5 个景点，不含这一站。原表记录途中在 Colac 服务区停留约 15 分钟（原参考时刻 09:30），保留作为可能的休息点，以当天实际安排为准。",
        "row": 170,
        "id": "2026-09-28-1",
        "tentative": true
      },
      {
        ...
        "note": "团方确认行程第 1 站。原表参考：停留约 60 分钟，参考时刻 11:00；实际时间以当天团方安排为准。\n原表提醒：不逆光，风大、注意防晒，不能飞无人机。",
        "row": 171,
        "id": "2026-09-28-2",
        "tentative": true
      },
      {
        ...
        "title": "吉布森石阶 · 第 2 站",
        "type": "spot",
        "place": "Gibson Steps Victoria",
        "note": "团方确认行程第 2 站。原表把这里记为可选：从十二门徒走小路约 1.1 公里过去，来回步行约 30–40 分钟，并注明「其实不太建议，有点赶」。现已是团方行程内的一站，按团队安排走，留意与十二门徒之间的时间分配。\n台阶下到海滩的开放情况受海况与维护影响，以现场公告为准。",
        "row": 173,
        "id": "2026-09-28-gibson",
        "tentative": true
      },
      {
        "time": null,
        ...
        "note": "团方确认行程第 3 站。原表参考：约 30 分钟，参考时刻 12:10。原表列出沉船湾大观景台、The Razorback 刀锋崖，以及回停车场途中的草地。",
        "row": 174,
        "id": "2026-09-28-3",
        "tentative": true
      },
      {
        "time": null,
        "title": "大洋路野生动物园 · 第 4 站（自费可选）",
        "type": "spot",
        "place": "Great Ocean Road Wildlife Park",
        "note": "团方确认行程第 4 站，自费项目，可以选择不参加。费用、停留时长和是否参加当天向团方确认；不参加时如何等车也要先问清楚。\n这一站取代了原表的「寻找野生考拉（有几率）」：原表指的是车上沿途碰运气看野生考拉（约 15 分钟，参考时刻 13:30），团方给的是需另付费的动物园，两者不是同一件事。\n园区位置与门票未经核实，只记录团方说法。",
        "row": 175,
        "id": "2026-09-28-wildlife-park",
        "optional": true,
        "tentative": true
      },
      {
        "time": null,
        "title": "阿波罗湾 · 第 5 站，自由午餐",
        "type": "food",
        "place": "Apollo Bay Victoria",
        "note": "团方确认行程第 5 站，也是返程前最后一站。原表参考：约 60 分钟自由午餐，参考时刻 13:50。\n海鲜拼盘或海鲜意面，饭后可选 Dooley’s 冰淇淋；店家与参考价见推荐菜。",
        "row": 177,
        "id": "2026-09-28-5",
        "tentative": true
      },
      {
        ...
        "type": "food",
        "place": "Melbourne CBD",
        "note": "团方确认在上车地点下车，即 206 A'Beckett St，从那里步行回盛橡（350 William St）。返回时间以当天团方安排为准，原表参考 19:50 回到墨尔本市区（19:30–20:00）。\n晚餐返城后自行解决：优先下车点或盛橡附近仍营业的简餐／外带，不固定餐厅，不赶预约；太累可买回房吃。原Phở Tùng不作当天固定安排。备选见推荐菜。",
        "row": 186,
        "id": "2026-09-28-9",
        "tentative": true
      },
      ...
      },
      {
        ...
        "type": "shop",
        "place": "Coles Melbourne CBD",
        "note": "次日补给（按9/29自由日推算）：9/29 早餐在酒店附近、午餐 Fitzroy brunch、晚上与老友聚餐，三餐都在外面，只需补水和路上小食，是全程最轻的一次。\n原表这一格写「买东西，具体看行李额额度」：伴手礼可在墨尔本比价，但占重量的大件留到悉尼 Coles World Square 一起买，9/29 晚才统一整理行李。\n原表也注明 9/28 当晚不安排额外购物 —— 大洋路一整天回来很累，只买水也可以。",
        "row": 196,
        "id": "2026-09-28-supply"
      }
    ],
    "number": 3
  },
  {
    ...
    "events": [
      ...
      {
        "id": "2026-09-29-supply",
        "title": "超市补给 · 只带路上的水与小食",
        "type": "shop",
        "row": 214,
        "time": null,
        "place": "Coles Melbourne CBD",
  ...
  },
  {
    ...
    "events": [
      ...
      {
        "id": "2026-09-30-supply",
        "title": "超市补给 · 备好次日包车零食",
        "type": "shop",
        "row": 279,
        "time": null,
        "place": "Coles World Square Sydney",
        "note": "次日补给（原表已写明）：原表这一格就是「Coles World Square · 明天包车零食」，并提醒零食提前备好、不为购物熬夜。Coles World Square 营业 6:00–00:00（原表），歌剧院散场后仍可顺路，但别为此熬夜。\n清单：车上零食与饮用水（10/1 全天在包车上，停留点少且分散）、纸巾湿巾。原表 10/1 准备栏另列晕车药（出发前半小时吃）、防晒、雨伞、驱蚊与一个大购物袋，缺哪样今晚一并补。\n早餐由 Song Hotel 提供（08:15 用餐），不用买。",
        "flexible": true
      }
    ],
    "number": 5
  ...
  },
  {
    ...
    "events": [
      ...
      {
        "id": "2026-10-02-supply",
        "title": "超市补给 · 买好回程日早餐",
        "type": "shop",
        "row": 453,
        "time": null,
        "place": "Coles World Square Sydney",
        "note": "次日补给（按10/3回程推算）：10/3 06:15 退房，酒店自助早餐 07:00 才开、当天不等开餐，原表已写明「前晚准备轻早餐」—— 所以早餐必须今晚买好，和 9/27 那晚同一个道理。\n清单：次日早餐（面包／三明治＋饮料）、少量随身零食（原表记 MU562 按航司配餐，自备少量即可，飞行 11:00–19:25）。水不用现在买，过安检后或登机口补（原表 10:00 登机准备一项写了补水）。\n退税商品与发票按 10/3 值机项的说明准备。Coles World Square 营业 6:00–00:00（原表）。\n本项与当天其余安排同为待打磨草案，不导出日历、不触发提醒。",
        "tentative": true
      }
    ],
    "number": 7
